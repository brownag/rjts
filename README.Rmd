...
This clones the Git repository and enters it, runs `install_jts()` (requires the development version be installed from GitHub as above), then runs `remotes::install_local()` to _re-install_ from the local instance of the package (where `"inst/java"` has been populated with relevant JAR files).
